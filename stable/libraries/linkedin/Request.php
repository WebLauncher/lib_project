...
define('CALLBACK_URL', 'http://www.iocoachingcommunity.com/site/connect?a=callback:linkedin');
...
define('CUSTOMER_KEY', 'yRWicCXNVoC5U0g-ruVU-cINJGGpWoJ96wR4RT-dJiIQ9Ud7fofR7KwDhhH-DJPU');
define('CUSTOMER_SECRET', 'TGzHjS0gBWkrcvUtlvCkJIrJBpzFnozF40mopEdEfakPDaPBKty46EkMcJqvMAGq');
...
class LinkedIn_Request
{
	...
	public function __construct($apikey=CUSTOMER_KEY,$secret=CUSTOMER_SECRET)
	{
		
		$oauth = new OAuth($apikey, $secret,
	...
	public function publishStatus ($status = null)
	{
		...
		$this->_oauth->fetch( BASE_API_URL .'/v1/people/~/current-status',$this->createXmlStatus(),OAUTH_HTTP_METHOD_PUT);
	}
	...
	public function parseProfile ()
	{
	  ...
	  foreach($profileXML->children() AS $key => $item)
	  {
