...
/*
  ...
  elseif (preg_match ("/SMTP error from remote mail server after RCPT TO: *<(\S+@\S+\w)>/i",$body,$match)) {
...
/*
  ...
  elseif (preg_match ("/This user doesn't have a yahoo.com account *(\S+@\S+\w)/i",$body,$match)) {
    $result['rule_cat']    = 'unknown';
    $result['rule_no']     = '0237';
    $result['email']       = $match[1];
  }
